    ...
    Node q, std::vector<Node>& terms, InferenceId id, Node pfArg, bool doVts)
{
  ...
  if (options().quantifiers.qlogging)
  {
     ...
     NodeVector c_terms(terms);
     if (instrument) {
       //        QuantifierLogger::s_logger->registerInstantiationRL(
       //          q, terms);
       QuantifierLogger::s_logger->registerInstantiation(q, true, c_terms);
     }
  }
...
Instantiate::Statistics::Statistics(StatisticsRegistry& sr)
    : d_instantiations(sr.registerInt("Instantiate::Instantiations_Total")),
      ...
      d_enum_check_calls(sr.registerInt("Instantiate::Enum_Check_Calls")),
      d_enum_check_done(sr.registerInt("Instantiate::Enum_Check_Done")),
      d_enum_process_calls(sr.registerInt("Instantiate::Enum_Process_Calls")),
      d_enum_process_attempts(sr.registerInt("Instantiate::Enum_Process_Attempts")),
      d_enum_process_success(sr.registerInt("Instantiate::Enum_Process_Success"))
{
}
