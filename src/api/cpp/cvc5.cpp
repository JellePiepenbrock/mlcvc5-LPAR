...
std::string Solver::getInstantiations() const
{
  ...
  //if (internal::options::qlogging())
  if (d_slv->getOptions().quantifiers.qlogging)
  {
     internal::theory::quantifiers::QuantifierLogger::s_logger->print(std::cout);
    /* theory::quantifiers::QuantifierLogger::s_logger.reset(nullptr); */
  }
